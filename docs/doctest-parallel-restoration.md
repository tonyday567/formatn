...
This document explains how to restore the `doctest-parallel` test suite to formatn.
...
### 1. Update formatn.cabal

Add the following test suite stanza back to `formatn.cabal`:
